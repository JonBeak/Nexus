...
export const TaskColumn: React.FC<Props> = ({
  ...
  return (
    <div className={`flex-shrink-0 w-72 rounded-lg border ${PAGE_STYLES.panel.border} ${PAGE_STYLES.panel.background}`}>
      {/* Column Header */}
      <div className={`flex items-center gap-2 px-3 py-2 border-b border-gray-200 rounded-t-lg ${
      ...
      {/* Tasks List */}
      <div className="h-[500px] overflow-y-auto p-2 space-y-2">
        {tasks.length === 0 ? (
