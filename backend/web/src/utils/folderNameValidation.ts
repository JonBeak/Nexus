/**
 * Folder Name Validation for Windows Compatibility
 *
 * Validates customer names, job names, and order names to ensure they can be
 * safely used as Windows folder names on SMB shares.
 *
 * Key Difference:
