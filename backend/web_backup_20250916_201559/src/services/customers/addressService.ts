...
export class AddressService {
  ...
  static async addAddress(customerId: number, addressData: AddressData, createdBy: string) {
    ...
    const insertQuery = `
      INSERT INTO customer_addresses (
        ...
        province_state_short, postal_zip, country, tax_override_percent, tax_type, tax_id,
        tax_override_reason, use_province_tax, comments, created_by
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    ...
    await query(insertQuery, [
      ...
      province_state_short, postal_zip || null, country,
      tax_override_percent || null, tax_type || null, tax_id || null,
      tax_override_reason || null, use_province_tax ? 1 : 0, comments || null, createdBy
    ]);
  }
  ...
  static async updateAddress(customerId: number, addressId: number, addressData: AddressData, updatedBy: string) {
    ...
    await query(updateQuery, [
      ...
      province_state_short || null, postal_zip || null, country || 'Canada',
      tax_override_percent || null, tax_type || null, tax_id || null,
      tax_override_reason || null, use_province_tax ? 1 : 0, comments || null, updatedBy,
