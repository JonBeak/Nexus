-- =============================================================================
-- Migration: 20251216_001_add_custom_message_to_templates.sql
-- Purpose: Add {customMessage} placeholder to email templates and update subject format
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Update full_invoice template
-- - Add {customMessage} placeholder after main message, before highlight box
-- - Subject format now uses {orderName} | Invoice #{orderNumber} (no customer name)
-- -----------------------------------------------------------------------------
UPDATE email_templates
SET
  subject = '{orderName} | Invoice #{orderNumber}',
  body = '<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
      ...
      <table class="container" role="presentation" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="content">
            ...
            <!-- Custom Message (optional - only shown if provided) -->
            {customMessage}
...
-- -----------------------------------------------------------------------------
-- Update deposit_request template
-- - Add {customMessage} placeholder after main message, before urgency box
-- - Subject format now uses {orderName} | Invoice #{orderNumber} - Deposit Required
-- -----------------------------------------------------------------------------
UPDATE email_templates
SET
  subject = '{orderName} | Invoice #{orderNumber} - Deposit Required',
  body = '<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
