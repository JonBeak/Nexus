-- Job Estimation System - Simplified
...
('Channel Letters - Front Lit', 'channel_letters', 'ea', 
  '{"fields": [{"name": "letter_data", "type": "textarea", "label": "Letter Analysis Data", "required": true}, {"name": "return_depth", "type": "select", "label": "Return Depth", "options": ["3\"", "4\"", "5\""], "required": true}]}',
  '{"base_rate_per_letter": 35.00, "depth_multipliers": {"3\"": 1.0, "4\"": 1.5, "5\"": 2.5}, "minimum_charge": 150.00}'
);

INSERT INTO addon_types (name, category, applicable_to, input_template, pricing_rules) VALUES
('Face Vinyl Application', 'finishing', '["Channel Letters - Front Lit"]', 
  '{"fields": [{"name": "vinyl_color", "type": "text", "label": "Vinyl Color/Type", "required": true}, {"name": "coverage_area", "type": "number", "label": "Coverage Area (sq ft)", "required": true}]}',
  '{"rate_per_sqft": 4.50, "setup_fee": 25.00, "minimum_charge": 50.00}'
),
('Return Painting', 'finishing', '["Channel Letters - Front Lit"]',
  '{"fields": [{"name": "paint_color", "type": "text", "label": "Paint Color", "required": true}, {"name": "letter_count", "type": "number", "label": "Number of Letters", "required": true}]}',
  '{"rate_per_letter": 8.00, "setup_fee": 35.00, "minimum_charge": 75.00}'
);